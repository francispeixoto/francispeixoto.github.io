...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(o){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("francispeixoto-com/app").default.create({name:"francispeixoto-com",version:"0.0.0+e14a983f"})
